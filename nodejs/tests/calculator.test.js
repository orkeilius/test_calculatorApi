...
describe("Calculator", () => {
    ...
    `("devrait retourner $a + $b = $expected", ({ a, b, expected }) => {
        ...
        it("devrait retourner ≈ 0.3 pour add(0.1, 0.2)", () => {
    ...
    `("devrait retourner $a - $b = $expected", ({ a, b, expected }) => {
        ...
        it("devrait retourner ≈ 0.2 pour subtract(0.3, 0.1)", () => {
    ...
    `("devrait retourner $a * $b = $expected", ({ a, b, expected }) => {
        ...
        it("devrait retourner ≈ 0.02 pour multiply(0.1, 0.2)", () => {
    ...
    `("devrait retourner $a / $b = $expected", ({ a, b, expected }) => {
        ...
        it("devrait retourner ≈ 3.333 pour divide(10, 3)", () => {
            expect(calculator.divide(10, 3)).toBeCloseTo(3.333);
        });

        it("devrait lever une erreur pour division par zéro", () => {
    ...
    describe("Cas de coercion JS", () => {
        it("add(null, 2) devrait retourner 2 (null coercé en 0)", () => {
            expect(calculator.add(null, 2)).toBe(2);
        });

        it("subtract(undefined, 5) devrait retourner NaN", () => {
            expect(calculator.subtract(undefined, 5)).toBeNaN();
        });

        it('multiply("abc", 3) devrait retourner NaN', () => {
            expect(calculator.multiply("abc", 3)).toBeNaN();
        });

        it("divide(NaN, 5) devrait retourner NaN", () => {
